...
- `cursor/<short-task>` (preferred for Cursor Cloud Agents)
- `agent/<short-feature-name>`
- `fix/<short-bug-name>`
- `chore/<short-task-name>`

Overnight / remote Mac-off workflow: see `docs/CLOUD-AGENT-OVERNIGHT.md`.
...
Do not merge pull requests automatically unless a human explicitly asks.
