...
| S6 | Lint warning backlog | 🟡 | 0 errors; 16 warnings left (agenda + Pagamento/GiornataProgrammata remounted; pages/nav remain) |
...
2. **S6** — Continue with `SpesaSheet` remount if prefill-safe; skip pages/hash/animation.
