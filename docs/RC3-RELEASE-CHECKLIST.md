...
|------------|----------|------------|----------------|-----------------|------|
| 2026-09-15 | Cursor Cloud (`cursor/overnight-cloud-hardening-74ac`) | **pass** (after PIN salt Uint8Array compat) | 0 errori / ~22 warning | OK | Docs architecture/roadmap added. PWA/device ancora pending. |
